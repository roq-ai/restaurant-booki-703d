...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        ...
        order: params.order,
        searchTermKeys: ['description_update.contains', 'name_update.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'description_update', header: 'Description Update', accessorKey: 'description_update' },
    { id: 'name_update', header: 'Name Update', accessorKey: 'name_update' },
